...
const CACHE_VERSION = 'agb-chantier-v2';
...
const DEFAULT_OFFLINE_DATA_SNAPSHOT = {
  ...
  projects: [
    {
      id: "proj_001_plateau_tower",
      code: "CH-2026-001",
      name: "Tour Horizon d'Affaires - R+14",
      status: "EN_COURS",
      progressPercentage: 35,
      location: { city: "Abidjan", district: "Plateau" },
      clientName: "Groupe SIFCA Immobilier",
      managementTeam: { siteManagerName: "M. Kouassi Yao", leadEngineerName: "Ing. Jean-Luc Mensah" },
      metrics: { workersOnSiteToday: 64, activeAlertsCount: 0 }
    },
    {
      ...
      location: { city: "Abidjan", district: "Cocody Ambassades" },
      clientName: "SCI Éden Riviera",
      managementTeam: { siteManagerName: "M. Mamadou Koné", leadEngineerName: "Ing. Jean-Luc Mensah" },
      metrics: { workersOnSiteToday: 42, activeAlertsCount: 0 }
    },
    {
      id: "proj_003_pont_bassam",
      code: "CH-2025-008",
      name: "Échangeur & Voie Rapide PK24",
      status: "EN_COURS",
      progressPercentage: 82,
      location: { city: "Grand-Bassam", district: "Zone Industrielle" },
      clientName: "Ministère de l'Équipement et de l'Entretien Routier (AGEROUTE)",
      managementTeam: { siteManagerName: "M. Bakary Coulibaly", leadEngineerName: "Ing. Philippe Vasseur" },
      metrics: { workersOnSiteToday: 89, activeAlertsCount: 1 }
    }
  ]
};
