      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <AppTextField
            ...
            onChange={(val) => setHourMeterCurrent(Number(val))}
            fullWidth
            required
          />
          ...
          <AppTextField
            ...
            onChange={(val) => setFuelConsumption(Number(val))}
            fullWidth
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <AppTextField
            ...
            onChange={(val) => setAssignedOperator(val)}
            fullWidth
          />
        </div>
        ...
        <AppTextField
          ...
          onChange={(val) => setDailyCostRateFCFA(Number(val))}
          fullWidth
