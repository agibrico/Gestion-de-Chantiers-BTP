...
export const EquipmentManagementScreen: React.FC = () => {
  ...
  const [selectedEquipmentForQr, setSelectedEquipmentForQr] = useState<EquipmentEntity | null>(null);
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="flex items-start justify-between">
                ...
                <div>
                  {item.status === "EN_SERVICE_CHANTIER" ? (
                    ...
                    <AppBadge variant="default">DISPONIBLE</AppBadge>
            ...
            <div className="pt-4 mt-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between gap-2">
              ...
              <div className="flex gap-1.5">
                <AppButton
                  ...
                  variant="outline"
                  onClick={() => {
                    setSelectedEquipmentForQr(item);
      ...
      {isQrModalOpen && selectedEquipmentForQr && (
        <QrCodeDisplay
          value={selectedEquipmentForQr.code}
          title={`${selectedEquipmentForQr.brand} ${selectedEquipmentForQr.model}`}
          subtitle={selectedEquipmentForQr.name}
