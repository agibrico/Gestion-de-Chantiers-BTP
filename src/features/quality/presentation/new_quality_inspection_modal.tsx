      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <AppSelect
            ...
            onChange={(val) => setInspectionType(val as InspectionType)}
            fullWidth
            required
          />
          ...
          <AppTextField
            ...
            onChange={(val) => setLocationDetails(val)}
            fullWidth
            required
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <AppTextField
            ...
            value={inspectorName}
            onChange={(val) => setInspectorName(val)}
            fullWidth
            required
          />
          ...
          <AppTextField
            ...
            value={inspectorOrg}
            onChange={(val) => setInspectorOrg(val)}
            fullWidth
            required
          />
        </div>
        ...
        <AppSelect
          ...
          value={status}
          onChange={(val) => setStatus(val as QualityStatus)}
          fullWidth
          required
        />
        ...
        <AppTextField
          ...
          value={observations}
          onChange={(val) => setObservations(val)}
          fullWidth
        />
        ...
        {status === "NON_CONFORME" && (
          <AppTextField
            ...
            onChange={(val) => setActionRequired(val)}
            fullWidth
            required
          />
        )}
