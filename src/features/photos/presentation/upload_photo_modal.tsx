      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <AppSelect
            ...
            options={TAG_OPTIONS}
            value={tag}
            onChange={(val) => setTag(val as PhotoTag)}
            fullWidth
            required
          />
          ...
          <AppTextField
            ...
            onChange={(val) => setZoneOrBuilding(val)}
            fullWidth
            required
          />
        </div>
        ...
        <div className="p-3 bg-slate-50 dark:bg-slate-800/40 rounded-xl border border-slate-200 dark:border-slate-800 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <AppTextField
              ...
              onChange={(val) => setLatitude(Number(val))}
              fullWidth
            />
            <AppTextField
              label="Longitude"
              ...
              onChange={(val) => setLongitude(Number(val))}
              fullWidth
            />
          </div>
        ...
        <AppTextField
          ...
          onChange={(val) => setDescriptionDecoder(val)}
          fullWidth
        />
