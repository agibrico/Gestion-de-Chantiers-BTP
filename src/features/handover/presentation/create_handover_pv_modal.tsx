      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <AppSelect
            ...
            value={verdict}
            onChange={(val) => setVerdict(val as HandoverVerdict)}
            fullWidth
            required
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <AppTextField
            ...
            onChange={(val) => setWarrantyEndDate(val)}
            fullWidth
            required
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <AppTextField
            ...
            onChange={(val) => setRetentionAmountFCFA(Number(val))}
            fullWidth
            required
          />
        ...
        <AppTextField
          ...
          onChange={(val) => setObservationsMOA(val)}
          fullWidth
        />
