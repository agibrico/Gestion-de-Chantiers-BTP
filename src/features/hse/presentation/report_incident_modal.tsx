      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <AppSelect
            ...
            value={category}
            onChange={(val) => setCategory(val as IncidentCategory)}
            fullWidth
            required
          />
          ...
          <AppSelect
            ...
            value={severity}
            onChange={(val) => setSeverity(val as IncidentSeverity)}
            fullWidth
            required
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <AppTextField
            ...
            value={exactLocation}
            onChange={(val) => setExactLocation(val)}
            fullWidth
            required
          />
          ...
          <AppTextField
            ...
            value={victimName}
            onChange={(val) => setVictimName(val)}
            fullWidth
          />
          ...
          <AppTextField
            ...
            onChange={(val) => setDaysOfSickLeave(Number(val))}
            fullWidth
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <AppTextField
            ...
            onChange={(val) => setRootCauseAnalysis(val)}
            fullWidth
          />
          ...
          <AppTextField
            ...
            onChange={(val) => setCorrectiveActions(val)}
            fullWidth
          />
        </div>
