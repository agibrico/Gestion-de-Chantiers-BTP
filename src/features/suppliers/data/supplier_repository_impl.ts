...
export class SupplierRepositoryImpl implements SupplierRepository {
  ...
  public async markAsDelivered(
    ...
    deliverySignature?: {
      ...
      deliverySignatoryName?: string;
      deliverySignatoryRole?: string;
    ...
    const updated: PurchaseOrderEntity = {
      ...
      deliveryNoteNumber,
      actualDeliveryDate,
      deliverySignatureDataUrl: deliverySignature?.deliverySignatureDataUrl,
      deliverySignatoryName: deliverySignature?.deliverySignatoryName,
      deliverySignatoryRole: deliverySignature?.deliverySignatoryRole,
      deliverySignedAt: deliverySignature?.deliverySignedAt,
      driverSignatureDataUrl: deliverySignature?.driverSignatureDataUrl,
      driverSignatoryName: deliverySignature?.driverSignatoryName,
      updatedAt: new Date().toISOString(),
    };
    await IdbAdapter.put<PurchaseOrderEntity>(IdbAdapter.STORES.PURCHASE_ORDERS, updated);
    return updated;
